    ...
    <section id="contact" className="mt-16 sm:mt-24">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-base sm:text-lg text-gray-600 px-4">
          Have questions about the course? Get in touch with us.
        </p>
      </div>
      ...
      <div className="max-w-3xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8">
          {/* Contact Information */}
          <div className="rounded-2xl p-6 sm:p-8 bg-brand-gradient-primary text-white">
            <h3 className="text-xl font-bold mb-4">Get In Touch</h3>
            <p className="mb-6">
              We&apos;re here to help you with any questions you might have about our IB & IGCSE Music Educators Course.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:border-brand-primary focus:ring-1 focus:ring-brand-primary"
                />
              </div>
              ...
              <button
                ...
                className="w-full rounded-lg px-5 py-3 text-white font-medium transition-all hover:shadow-lg disabled:opacity-70"
